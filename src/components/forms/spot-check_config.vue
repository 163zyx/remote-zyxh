<template>
  <div>
    ...
    <el-breadcrumb separator="/">
      ...
      <el-breadcrumb-item>抽检用户管理</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 卡片视图 -->
    <el-card style="height: 85vh">
      ...
      >
        <el-table-column prop="servicename" label="抽检用户">
        </el-table-column>
        <el-table-column prop="price" label="简称">
...
export default {
  ...
  data() {
    return {
      ...
      titleMap: {
        add: "新增抽检用户", //根据自己内容定义名字
        edit: "编辑抽检用户", //根据自己内容定义名字
      },
    };
  },
